...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (current-temp room1) 70.27) ;71.87

    (= (vav-energy-vfast room1) 0.09157)
    (= (vav-energy-fast room1)0.07326)
    (= (vav-energy-slow room1) 0.05494)
    (= (vav-energy-vslow room1) 0.03663)
    (= (vav-energy-on room1) 0.01834)
    (= (vav-energy-idle room1) 0.00002)
	
    (= (ahu-energy-vfast room1) 0.331)
    (= (ahu-energy-fast room1) 0.265)
    (= (ahu-energy-slow room1) 0.198)
    (= (ahu-energy-vslow room1) 0.132)
    (= (ahu-energy-on room1) 0.0.066)
