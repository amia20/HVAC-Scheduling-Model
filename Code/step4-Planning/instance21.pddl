...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.0897)
    (= (vav-energy-fast room1) 0.07176)
    (= (vav-energy-slow room1) 0.05383)
    (= (vav-energy-vslow room1) 0.03589)
    (= (vav-energy-on room1) 0.01796)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.214)
    (= (ahu-energy-fast room1) 0.172)
    (= (ahu-energy-slow room1) 0.129)
    (= (ahu-energy-vslow room1) 0.086)
    (= (ahu-energy-on room1) 0.043)
