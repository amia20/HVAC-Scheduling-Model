...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.06568)
    (= (vav-energy-fast room1) 0.05254)
    (= (vav-energy-slow room1) 0.03942)
    (= (vav-energy-vslow room1) 0.02628)
    (= (vav-energy-on room1) 0.01314)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.206)
    (= (ahu-energy-fast room1) 0.165)
    (= (ahu-energy-slow room1) 0.124)
