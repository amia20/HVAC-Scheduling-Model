...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.08157)
    ...
    (= (ahu-energy-vfast room1) 0.3)
    (= (ahu-energy-fast room1) 0.24)
    (= (ahu-energy-slow room1) 0.18)
    (= (ahu-energy-vslow room1) 0.12)
    (= (ahu-energy-on room1) 0.06)
