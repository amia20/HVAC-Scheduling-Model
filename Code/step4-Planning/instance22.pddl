...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.09783)
    (= (vav-energy-fast room1) 0.07828)
    (= (vav-energy-slow room1) 0.05871)
    (= (vav-energy-vslow room1) 0.03914)
    (= (vav-energy-on room1) 0.01959)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.249)
    (= (ahu-energy-fast room1) 0.199)
    (= (ahu-energy-slow room1) 0.149)
    (= (ahu-energy-vslow room1) 0.1)
