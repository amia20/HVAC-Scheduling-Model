...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (current-temp room1) 72.04) ;71.87
	
    (= (vav-energy-vfast room1) 0.07773)
    (= (vav-energy-fast room1) 0.06219)
    (= (vav-energy-slow room1) 0.04665)
    (= (vav-energy-vslow room1) 0.0311)
    (= (vav-energy-on room1) 0.01557)
    (= (vav-energy-idle room1) 0.00002)


    (= (ahu-energy-vfast room1) 0.364)
    (= (ahu-energy-fast room1) 0.291)
    (= (ahu-energy-slow room1) 0.218)
    (= (ahu-energy-vslow room1) 0.146)
    (= (ahu-energy-on room1) 0.073)
