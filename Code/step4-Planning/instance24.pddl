...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (current-temp room1) 71.87) ;71.87
	
	(= (vav-energy-vfast room1) 0.06406)
    (= (vav-energy-fast room1) 0.05124)
    (= (vav-energy-slow room1) 0.03844)
    (= (vav-energy-vslow room1) 0.02564)
    (= (vav-energy-on room1) 0.01282)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.194)
    (= (ahu-energy-fast room1) 0.155)
    (= (ahu-energy-slow room1) 0.117)
    (= (ahu-energy-vslow room1) 0.078)
    (= (ahu-energy-on room1) 0.039)
