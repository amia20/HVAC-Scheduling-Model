...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.10796)
    (= (vav-energy-fast room1) 0.08638)
    (= (vav-energy-slow room1) 0.06478)
    (= (vav-energy-vslow room1) 0.0432)
    (= (vav-energy-on room1) 0.0216)
    (= (vav-energy-idle room1) 0.00003)

    (= (ahu-energy-vfast room1) 0.145)
    (= (ahu-energy-fast room1) 0.116)
    (= (ahu-energy-slow room1) 0.087)
    (= (ahu-energy-vslow room1) 0.058)
    (= (ahu-energy-on room1) 0.029)
