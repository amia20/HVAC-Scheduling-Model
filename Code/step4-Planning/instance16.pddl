...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.08719)
    (= (vav-energy-fast room1) 0.06974)
    (= (vav-energy-slow room1) 0.05232)
    (= (vav-energy-vslow room1) 0.03488)
    (= (vav-energy-on room1) 0.01744)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.252)
    (= (ahu-energy-fast room1) 0.202)
    (= (ahu-energy-slow room1) 0.151)
    (= (ahu-energy-vslow room1) 0.101)
    (= (ahu-energy-on room1)  0.05)
