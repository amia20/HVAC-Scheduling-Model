...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.15415)
    (= (vav-energy-fast room1) 0.12335)
    (= (vav-energy-slow room1) 0.06478)
    (= (vav-energy-vslow room1) 0.06167)
    (= (vav-energy-on room1) 0.03086)
    (= (vav-energy-idle room1) 0.00003) 

    (= (ahu-energy-vfast room1) 0.288)
    (= (ahu-energy-fast room1) 0.23)
    (= (ahu-energy-slow room1) 0.173)
    (= (ahu-energy-vslow room1) 0.115)
    (= (ahu-energy-on room1) 0.058)
