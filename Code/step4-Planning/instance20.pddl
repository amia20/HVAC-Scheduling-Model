...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.0615)
    (= (vav-energy-fast room1) 0.0492)
    (= (vav-energy-slow room1) 0.03691)
    (= (vav-energy-vslow room1) 0.02461)
    (= (vav-energy-on room1) 0.01232)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.357)
    (= (ahu-energy-fast room1) 0.286)
    (= (ahu-energy-slow room1) 0.215)
    (= (ahu-energy-vslow room1) 0.143)
    (= (ahu-energy-on room1) 0.072)
