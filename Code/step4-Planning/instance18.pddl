...
(:init
   ...
   ; (= (ahu-energy ahu1) 0.16)
    ...
    (= (vav-energy-vfast room1) 0.09247)
    (= (vav-energy-fast room1) 0.07398)
    (= (vav-energy-slow room1) 0.05549)
    (= (vav-energy-vslow room1) 0.037)
    (= (vav-energy-on room1) 0.01851)
    (= (vav-energy-idle room1) 0.00002)

    (= (ahu-energy-vfast room1) 0.313)
    (= (ahu-energy-fast room1) 0.251)
    (= (ahu-energy-slow room1) 0.188)
    (= (ahu-energy-vslow room1) 0.125)
    (= (ahu-energy-on room1) 0.063)
